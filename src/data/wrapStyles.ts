// AI Decal Studio — style catalogue + server-side prompt composer.
// Display fields (id/name/group) are used by the UI; `core` + `variants` feed
// the image model. buildWrapPrompt() is called on the server only.
